...
<div class="max-w-4xl mx-auto p-6">
    ...
    <ul class="list-disc ms-6">
        <?php $__currentLoopData = $prestationsObligatoires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li><?php echo e($p); ?></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </ul>
    ...
    <p class="mt-4 text-lg">
        ...
        <?php echo e(number_format($prixTotal, 2, ',', ' ')); ?> €
    </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/pierrard/Documents/lexpertimmo/resources/views/devis/resultat.blade.php ENDPATH**/ ?>