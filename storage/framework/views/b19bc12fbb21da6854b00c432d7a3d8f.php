...
<div class="bg-white shadow rounded">
    <div class="px-6 py-4 flex items-center justify-between">
        <div>
            <p class="text-lg font-semibold text-gray-800"><?php echo e($user->nom); ?></p>
...
<table class="table">
    ...
    <tbody>
        <?php $__currentLoopData = $rendezvousBloques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rdv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($rdv->user->nom ?? 'Non assigné'); ?></td>
                <td><?php echo e($rdv->user->email ?? 'Non assigné'); ?></td>
                <td><?php echo e($rdv->rue ?? 'N/A'); ?></td>
                <td><?php echo e($rdv->code_postal ?? 'N/A'); ?></td>
                <td><?php echo e($rdv->ville ?? 'N/A'); ?></td>
                <td><?php echo e($rdv->zone); ?></td>
                <td><?php echo e($rdv->date->format('d/m/Y H:i')); ?></td>
                <td>
    
    <a href="<?php echo e(route('admin.rendezvous.edit', $rdv->id)); ?>">
        Modifier
    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/pierrard/Documents/lexpertimmo/resources/views/Admin/dashboard_Admin.blade.php ENDPATH**/ ?>