...
<div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <form method="POST" action="<?php echo e(route('contact.store')); ?>" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <?php echo csrf_field(); ?>
    ...
    <?php if(session('contact_id')): ?>
        <div class="mt-4">
            <a href="<?php echo e(route('user.contact', ['id' => session('contact_id')])); ?>" class="text-blue-600 hover:underline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\laragon\www\lexpertimmo\resources\views/contact.blade.php ENDPATH**/ ?>