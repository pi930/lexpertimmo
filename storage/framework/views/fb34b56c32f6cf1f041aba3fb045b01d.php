<div class="space-y-6">
                    ...
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-t hover:bg-gray-100">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                <a href="<?php echo e(route('messages.edit', $contact->id)); ?>" class="text-sm text-yellow-600 hover:underline">Modifier</a>
    ...
    <?php else: ?>
        ...
        <div class="mt-4"><?php echo e($messages->links()); ?></div>
    <?php endif; ?>
</div><?php /**PATH C:\laragon\laragon\www\lexpertimmo\resources\views/components/dashboard/messages.blade.php ENDPATH**/ ?>