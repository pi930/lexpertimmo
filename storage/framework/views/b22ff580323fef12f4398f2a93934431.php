        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                   <a href="<?php echo e(Auth::user()->role === 'admin' ? route('dashboard.admin') : route('user.dashboard')); ?>">
...
<?php endif; ?>
    ...
    <div class="px-4 py-2 border-t border-gray-200 dark:border-gray-600">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $latestNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e($notif->url ?? '#'); ?>" class="block px-2 py-1 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
        ...
        <div class="mt-2 text-end">
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-xs text-blue-600 dark:text-blue-400 hover:underline">Voir toutes les notifications</a>
        </div>
    </div>
<?php endif; ?>
            </div>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
    ...
    <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-600 dark:text-gray-300 hover:underline">Connexion</a>
        <a href="<?php echo e(route('register')); ?>" class="text-sm text-gray-600 dark:text-gray-300 hover:underline">Inscription</a>
        <a href="<?php echo e(route('contact.form')); ?>" class="text-sm text-gray-600 dark:text-gray-300 hover:underline">Contact</a>
    </div>
<?php endif; ?>
                <div class="ms-1">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('coordonnees.show')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('coordonnees.show'))]); ?>
    Mes coordonnées
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => Auth::user()->is_admin ? route('dashboard.admin') : route('dashboard.user'),'active' => request()->routeIs('dashboard.admin') || request()->routeIs('dashboard.user')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()->is_admin ? route('dashboard.admin') : route('dashboard.user')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard.admin') || request()->routeIs('dashboard.user'))]); ?>
...
<?php /**PATH C:\laragon\laragon\www\lexpertimmo\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>