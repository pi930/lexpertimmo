...
<div class="container">
    ...
    <?php if(auth()->guard()->check()): ?>
        <p class="text-success">Bienvenue <?php echo e(Auth::user()->nom); ?> !</p>
    <?php else: ?>
        <p class="text-warning">Connectez-vous pour créer un devis personnalisé.</p>
    <?php endif; ?>
    
    <?php if($user): ?>
        pour <?php echo e($user->nom); ?>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('devis.generer', ['prestation' => $prestation->id])); ?>" class="btn btn-primary">Créer mon devis</a>
                        <?php else: ?>
            ...
            <fieldset class="mb-4">
                ...
                <?php $__currentLoopData = [
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="options[]" value="<?php echo e($value); ?>" id="<?php echo e($value); ?>"
                            <?php echo e(in_array($value, $options) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/pierrard/Documents/lexpertimmo/resources/views/prestations.blade.php ENDPATH**/ ?>