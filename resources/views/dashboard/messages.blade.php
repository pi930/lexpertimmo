                ...
                <tbody>
                    @foreach($messages as $contact)
                        <tr class="border-t hover:bg-gray-100 cursor-pointer"
                            ...
                            <td class="px-4 py-2">
                                <a href="{{ route('admin.dashboard.user', ['id' => $contact->user_id]) }}"
                            ...
                            <td class="px-4 py-2 space-x-2">
                                {{-- Modifier --}}
                                <a href="{{ route('messages.edit', $contact->id) }}"
                                ...
                                {{-- Répondre --}}
                                <a href="{{ route('messages.reply', $contact->id) }}"
                                   class="text-sm text-blue-600 hover:underline">Répondre</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
